...
from .utils import AppListElementMixin
    ...
    def init_with_context(self, context):
        ...
        for model, perms in items:
            ...
            apps[app_label]["models"].append(
                {"title": model._meta.verbose_name_plural, "url": self._get_admin_change_url(model, context)}
            )
...
class Bookmarks(MenuItem, AppListElementMixin):
    ...
    def init_with_context(self, context):
        ...
        app_label = Bookmark._meta.app_label  # noqa
        model_name = Bookmark._meta.model_name  # noqa
