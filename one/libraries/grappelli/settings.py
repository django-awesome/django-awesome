...
# Admin Site Title
ADMIN_HEADLINE = getattr(settings, "GRAPPELLI_ADMIN_HEADLINE", "Django Awesome")
ADMIN_TITLE = getattr(settings, "GRAPPELLI_ADMIN_TITLE", "Django Awesome")
...
# SWITCH_USER_ORIGINAL: Defines if a user is allowed to log in as another user.
...
# Gets a user object and returns True/False.
SWITCH_USER_TARGET = getattr(
    settings, "GRAPPELLI_SWITCH_USER_TARGET", lambda original_user, user: user.is_staff and not user.is_superuser
)
